...
const COLUMNS: { key: SortKey; label: string; align?: "right" | "left"; numeric?: boolean }[] = [
  ...
  { key: "assets", label: "Assets", align: "right", numeric: true },
  { key: "equity", label: "Equity", align: "right", numeric: true },
...
export default function ScreenerPage() {
  ...
  const [data, setData] = useState<IDXFinancialRatio[]>([]);
  ...
  useEffect(() => {
    async function fetch() {
      const { data: rows, error } = await supabase
        ...
        .select("*")
        .order("code");
      if (!error && rows) setData(rows as IDXFinancialRatio[]);
      setLoading(false);
    }
    fetch();
  }, []);
              ...
              >
                ...
                <TableCell align="right">
                  <Typography variant="caption" sx={{ fontFamily: "monospace" }}>
                    {formatBillion(r.assets)}
                  </Typography>
                </TableCell>
                <TableCell align="right">
                  <Typography variant="caption" sx={{ fontFamily: "monospace" }}>
                    {formatBillion(r.equity)}
                  </Typography>
                </TableCell>
                <TableCell align="right">
                  <Typography variant="caption" sx={{ fontFamily: "monospace" }}>
                ...
                <TableCell align="right">
                  <Typography
                    variant="caption"
                    sx={{ fontFamily: "monospace", color: ratioColor(r.roa) }}
                  >
                    {formatRatio(r.roa)}%
                  </Typography>
                </TableCell>
